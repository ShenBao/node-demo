...
var users = [{id: 1, name: 'test1',mny:100}, {id: 2, name: 'test2',mny:100}];
/**
...
//curl -X POST --data "name=test3"  http://localhost:8080/users
...
//整体更新全部属性
// curl -X PUT --data "id=2&name=test20"  http://localhost:8080/users/2
...
//局部更新 请求体里只传要更新的字段
//curl -X PATCH --data "name=test200"  http://localhost:8080/users/2
